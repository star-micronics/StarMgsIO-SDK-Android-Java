    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        outputConditionSettingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mScaleType == ScaleType.MGS) {
                    switch (index){
                        case 0: scaleOutputCondition = ScaleOutputConditionSetting.StopOutput;                                                   break; //Output Condition 0
                        case 1: scaleOutputCondition = ScaleOutputConditionSetting.ContinuousOutputAtAllTimes;                                   break; //Output Condition 1
                        case 2: scaleOutputCondition = ScaleOutputConditionSetting.ContinuousOutputAtStableTimes;                                break; //Output Condition 2
                        case 3: scaleOutputCondition = ScaleOutputConditionSetting.PushDownKeyForOneTimeInstantOutput;                           break; //Output Condition 3
                        case 4: scaleOutputCondition = ScaleOutputConditionSetting.AutoOutput;                                                   break; //Output Condition 4
                        case 5: scaleOutputCondition = ScaleOutputConditionSetting.OneTimeOutputAtStableTimes;                                   break; //Output Condition 5
                        case 6: scaleOutputCondition = ScaleOutputConditionSetting.OneTimeOutputAtStableTimesAndContinuousOutputAtUnstableTimes; break; //Output Condition 6
                        case 7: scaleOutputCondition = ScaleOutputConditionSetting.PushDownKeyForOneTimeOutputAtStableTimes;                     break; //Output Condition 7
                    }
                }
                else if (mScaleType == ScaleType.MGTS) {
                    switch (index){
                        case 0: scaleOutputCondition = ScaleOutputConditionSetting.ContinuousOutputAtAllTimes;                                   break; //Output Condition 1
                        case 1: scaleOutputCondition = ScaleOutputConditionSetting.ContinuousOutputAtStableTimes;                                break; //Output Condition 2
                    }
                }
                Toast.makeText(ScaleActivity.this, scaleOutputCondition.toString(), Toast.LENGTH_SHORT).show();
